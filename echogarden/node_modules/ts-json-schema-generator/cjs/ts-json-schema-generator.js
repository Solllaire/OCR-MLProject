...
const formatError_js_1 = require("./src/Utils/formatError.js");
const node_fs_2 = tslib_1.__importDefault(require("node:fs"));
const pkg = JSON.parse(node_fs_2.default.readFileSync("package.json", "utf8"));
...
try {
    ...
    if (error instanceof BaseError_js_1.BaseError) {
        process.stderr.write((0, formatError_js_1.formatError)(error));
        process.exit(1);
    }
    else {
        throw error;
